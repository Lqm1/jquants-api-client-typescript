/**
 * J-Quants API Client TypeScript - Enums
 */

/**
 * Values of sections for investor-types API.
 *
 * @see https://jpx-jquants.com/ja/spec/eq-investor-types/section
 * @see https://jpx-jquants.com/en/spec/eq-investor-types/section
 */
...
export type MarketApiSection = typeof MARKET_API_SECTIONS[keyof typeof MARKET_API_SECTIONS];
...
export type BulkEndpointValue = typeof BulkEndpoint[keyof typeof BulkEndpoint];
